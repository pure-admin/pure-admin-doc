---
title: Tailwind CSS
date: 2022-09-07 17:40:34
permalink: /pages/39156f/
---
...
`tailwindcss` 官方建议我们尽量少使用 `@apply` ，具体原因参考 [avoiding-premature-abstraction](https://tailwindcss.com/docs/reusing-styles#avoiding-premature-abstraction)
:::
...
## `CSSNANO`
- [cssnano中文文档](https://www.cssnano.cn/)
...
讲个笑话，平台其实在 `CSS 框架` 选型中一共经历了`三`个阶段。  
