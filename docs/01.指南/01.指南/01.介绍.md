...
[vue-pure-admin](https://github.com/pure-admin/vue-pure-admin) 是一款开源免费且开箱即用的中后台管理系统模版。使用 `纯ESM`、`Vue3`、`Element-Plus`、`Vite`、`TypeScript`、`Pinia`、`Tailwind CSS` 等主流技术栈开发
