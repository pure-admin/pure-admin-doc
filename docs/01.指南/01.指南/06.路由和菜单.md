...
[resetRouter](https://gitee.com/yiming_chang/vue-pure-admin/blob/main/src/router/index.ts#L101) <Badge text="代码"/>
...
- [实现代码参考](https://gitee.com/yiming_chang/vue-pure-admin/blob/main/src/router/modules/remaining.ts#L32)，因为这种场景极少发生，所以只需在前端配置即可，配置的相对路径`src/router/modules/remaining.ts`
