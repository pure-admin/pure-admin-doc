...
② 加入类型支持，在 [interface PlatformConfigs](https://gitee.com/yiming_chang/pure-admin-thin/blob/main/types/global.d.ts#L84) 里加上 `Handsome?: boolean`，具体如下
...
[package.json](https://gitee.com/yiming_chang/pure-admin-thin/blob/main/package.json#L6-24) 文件中的 `scripts` 配置中存放平台的各种命令，具体如下
