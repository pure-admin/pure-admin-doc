...
具体实现代码位置 [build/index.ts](https://gitee.com/yiming_chang/vue-pure-admin/blob/main/build/index.ts#L32)
...
② 加入类型支持，在 [declare interface ViteEnv](https://gitee.com/yiming_chang/pure-admin-thin/blob/main/types/global.d.ts#L86) 里加上 `VITE_HANDSOME: boolean`，具体如下
...
② 加入类型支持，在 [declare interface ServerConfigs](https://gitee.com/yiming_chang/pure-admin-thin/blob/main/types/global.d.ts#L95) 里加上 `Handsome?: boolean`，具体如下
...
[package.json](https://gitee.com/yiming_chang/pure-admin-thin/blob/main/package.json#L5-24) 文件中的 `scripts` 配置中存放平台的各种命令，具体如下
