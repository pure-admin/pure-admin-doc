...
当然第二种办法也是最方便的办法就是将下面代码加入到您自己库的 `package.json` 里 [查看具体参考](https://github.com/xiaoxian521/pure-admin-table/blob/main/package.json#L24-L26)
...
答：[请点击这里查看原因](https://github.com/xiaoxian521/vue-pure-admin/issues/397#issue-1492326492)
