...
`vue-django-docker` [前端代码](https://gitee.com/Muzi-Li-Chine/vue-django-docker/tree/master/web) [后端代码](https://gitee.com/Muzi-Li-Chine/vue-django-docker/tree/master/backend) [预览地址](https://admin.vuedj.com/)(登录用户名：`superadmin` 密码：`admin123456`)
