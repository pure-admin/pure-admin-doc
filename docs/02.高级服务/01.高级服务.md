...
<p style="color:red;font-weight:500;font-size:22px"><a href="https://pure-admin-utils.netlify.app/" target="_blank" rel="noopener noreferrer">@pureadmin/utils</a> 源码首次限时开放销售，售价 ¥399，提供永久的源码使用、更新以及问题咨询服务，感兴趣的可以私信咨询（微信号：<span style="color:#426feb">pureadmin</span>）。该源码在众多实际项目打磨多年，结合 AI 可改造为自己的工具库。</p>
...
| ------ | ----------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| Max    | 基于 [vue-pure-admin（完整版）](https://github.com/pure-admin/vue-pure-admin)开发   | TypeScript | 包含所有基础功能 + 更多高级功能；需要等待平台发布新版本后更新同步代码，更新较慢                           | 代码较臃肿，含大量演示代码，不适合实际项目开发 |
| Max-Ts | 基于 [pure-admin-thin（精简版）](https://github.com/pure-admin/pure-admin-thin)开发 | TypeScript | 拥有 Max 版本的所有高级功能且比它功能更多；平台提交一至两次代码后就立刻同步更新，无需等待新版本，更新极快 | 代码体积小，适合实际项目开发                   |
| Js     | 基于 [pure-admin-thin（精简版）](https://github.com/pure-admin/pure-admin-thin)开发 | JavaScript | 无任何高级功能；需要等待平台发布新版本后更新同步代码，更新较慢                                            | 代码体积小，适合仅需基础功能的项目             |
| Max-Js | 基于 Js 版本开发                                                                    | JavaScript | 添加了与 Max-Ts 版本相同的高级功能；平台提交一至两次代码后就立刻同步更新，无需等待新版本，更新极快        | 代码体积小，适合实际项目开发                   |

:::tip 温馨提示

1. Max-Ts 和 Max-Js 是平台最高级别的版本，未来也不会有更高级别的版本
2. 购买上述任一版本后，如在使用过程中发现该版本软件存在程序缺陷（Bug），可直接微信反馈，我会尽快修复

:::

<style scoped>
#app > div.theme-container.sidebar-open.have-rightmenu.only-sidebarItem > div:nth-child(5) > main > div.theme-vdoing-wrapper > div.content-wrapper > div.theme-vdoing-content.content__default > table:nth-child(5) > thead > tr > th:nth-child(1) {
  width: 56px;
}
#app > div.theme-container.sidebar-open.have-rightmenu.only-sidebarItem > div:nth-child(5) > main > div.theme-vdoing-wrapper > div.content-wrapper > div.theme-vdoing-content.content__default > table:nth-child(5) > thead > tr > th:nth-child(2) {
  width: 158px;
}
#app > div.theme-container.sidebar-open.have-rightmenu.only-sidebarItem > div:nth-child(5) > main > div.theme-vdoing-wrapper > div.content-wrapper > div.theme-vdoing-content.content__default > table:nth-child(5) > thead > tr > th:nth-child(5) {
  width: 150px;
}
</style>
...
<p style="color:red">Js 版本支持补差价升级至 Max-Js 版本；<br/>Max 版本支持补差价升级至 Max-Ts 版本；<br/>Js、Max、Max-Js、Max-Ts 这四个版本都支持补差价升级进入解答微信群。</p>

## 解答微信群

| 价格（￥） | 包含内容                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 698        | [解答微信群](#解答微信群)、[Js 版本](#js-版本)、[Max 版本](#max-版本)、[Max-Js 版本](#max-js-版本)                                                                                                                                                                                                                                                                                                                                                                                                  |
| 798        | [解答微信群](#解答微信群)、[Js 版本](#js-版本)、[Max 版本](#max-版本)、[Max-Js 版本](#max-js-版本)、<a href="#max-ts-版本" style="color:red;text-decoration:none;">Max-Ts 版本</a>                                                                                                                                                                                                                                                                                                                  |
| 998        | [解答微信群](#解答微信群)、[Js 版本](#js-版本)、[Max 版本](#max-版本)、[Max-Js 版本](#max-js-版本)、[Max-Ts 版本](#max-ts-版本)、<span style="color:red;font-weight: 500;">一对一私聊解答</span>                                                                                                                                                                                                                                                                                                    |
| 1688       | [解答微信群](#解答微信群)、[Js 版本](#js-版本)、[Max 版本](#max-版本)、[Max-Js 版本](#max-js-版本)、[Max-Ts 版本](#max-ts-版本)、<span style="color:red;font-weight: 500;">一对一私聊解答可远程解决问题</span>、<br /><a href="https://pure-admin-utils.netlify.app/" target="_blank" rel="noopener noreferrer" style="color:red;font-weight:500;text-decoration:none;" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">@pureadmin/utils 源码</a> |

:::tip 买前提示

1. 无论哪种价格都同等享有下方红色字体的服务内容和视频教程
2. 无论哪种价格都同等享有永久的解答服务且不限问题数量
3. 支持补差价（比如之前698购买服务，想升级到998服务，（998 - 698）补300即可）
...
[vue-pure-admin](https://github.com/pure-admin/vue-pure-admin) 每次发版后，`JS`版本将优先同步更新，多数情况下一周内完成同步更新，而 [pure-admin-thin](https://github.com/pure-admin/pure-admin-thin) 版本最晚两个月内同步更新完成。
...
![img](~@alias/img/advanced/maxts.jpg)

② 新增菜单风格功能

![img](~@alias/img/advanced/menu-style/1.jpg)
<br />

![img](~@alias/img/advanced/menu-style/2.jpg)
...
![img](~@alias/img/advanced/maxjs.jpg)
