...
<p style='color: #673AB7;font-size:20px'>如何精简代码？（平台已推出针对不同版本如何精简代码的视频教程）</p>
<p style='color: #673AB7;font-size:20px'>上述视频教程是平台提供的增值服务，对应版本用户可前往相应GitHub仓库的README.md文件，搜索“视频教程”即可免费获取！</p>
<p style='color: #673AB7;font-size:16px'>温馨提示：不同版本仅包括Js、Max、Max-Ts、Max-Js这四个版本。Max版本精简教程重点体验在页面的精简上，删除所有演示示例。Js、Max-Ts、Max-Js这三个版本本身就是精简后的代码，我们会在精简后的基础上再度精简，删除所有页面并教学如何自定义一个页面替换首页。这些不仅仅体验在页面上也会体验到代码里，也就是对应页面的所有代码包括依赖都会被删除，实现极致精简！</p>

## 最新活动与动态

<p style='font-size:17px'>日历排班高级功能已推出！（该功能已集成到 Max、Max-Ts、Max-Js这三个版本）</p>

<p style='font-size:17px'>最新活动：Js版本和Max版本组合优惠、Max-Ts版本和Max-Js版本组合优惠</p>
