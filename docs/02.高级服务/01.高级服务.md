...
<p style='color: red;font-size:20px'>如何精简代码？（平台即将推出针对不同版本如何精简代码的视频教程）</p>
<p style='color: red;font-size:16px'>温馨提示：不同版本仅包括Js、Max、Max-Ts、Max-Js这四个版本。Max版本精简教程重点体验在页面的精简上，删除所有演示示例。Js、Max-Ts、Max-Js这三个版本本身就是精简后的代码，我们会在精简后的基础上再度精简，删除所有页面并教学如何自定义一个页面替换首页。这些不仅仅体验在页面上也会体验到代码里，也就是对应页面的所有代码包括依赖都会被删除，实现极致精简！</p>
<p style='color: red;font-size:16px'>上述视频教程是平台提供的增值服务，上线后，对应版本用户可免费领取专属视频教程！</p>

## 最新活动与动态

<p style='color: red;font-size:17px'>日历排班高级功能已推出！（该功能已集成到 Max、Max-Ts、Max-Js这三个版本）</p>

<p style='color: red;font-size:17px'>最新活动：Js版本和Max版本组合优惠、Max-Ts版本和Max-Js版本组合优惠</p>

<p style='color: red;font-size:17px'>最新动态：近期平台将对所有与 pure-admin 相关的版本进行全面优化，包括但不限于 Bug 的修复、功能的新增与优化。目前外包项目已全部开发完成。自即日起至 2025 年 10 月底，将暂停承接新的外包项目，以便集中精力推进 pure-admin 的版本迭代以及一项“新的筹备工作”。对于已交付的外包项目，仍可正常提供后续维护支持。<br/>温馨提示：① 当你在反馈问题时需详细备注问题以及如何复现问题并且提供复现仓库（这一步是必须的），否则将无法处理此类问题反馈，建议补充完整信息后再提交，望理解！② 对于功能的新增与优化平台已经规划完毕，若你有新的功能建议或改进方案，欢迎直接提交 Pull Request，我们将优先审核并尽快处理。</p>
