...
② 购买 [Max-Ts](#max-ts-版本) 和 [Max-Js](#max-js-版本) 两个版本，只需 `￥568`（仅提供 Max-Ts 和 Max-Js 两个版本，Max 版本和 Js 版本仅在单独购买的情况下赠送，比如单独购买 Max-Ts 版本送 Max 版本，单独购买 Max-Js 版本送 Js 版本）
...
② 购买 [Max-Js](#max-js-版本) 和 [Max-Ts](#max-ts-版本) 两个版本，只需 `￥568`（仅提供 Max-Ts 和 Max-Js 两个版本，Max 版本和 Js 版本仅在单独购买的情况下赠送，比如单独购买 Max-Ts 版本送 Max 版本，单独购买 Max-Js 版本送 Js 版本）
