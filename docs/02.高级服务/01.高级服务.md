...
| 1288       | [解答微信群](#解答微信群)、[Js 版本](#js-版本)、[Max 版本](#max-版本)、[Max-Js 版本](#max-js-版本)、[Max-Ts 版本](#max-ts-版本)、<span style="color:#426feb;font-weight: 500;">一对一私聊解答</span>、<br /><span style="color:red;font-weight: 500;">一次性送$200的ClaudeCode额度或$400的CodeX额度，并提供AI指导（从安装到使用）</span>                                                                                                                                                            |
...
<style scoped>
#app > div.theme-container.sidebar-open.have-rightmenu.only-sidebarItem > div:nth-child(6) > main > div.theme-vdoing-wrapper > div.content-wrapper > div.theme-vdoing-content.content__default > table:nth-child(134) > thead > tr > th:nth-child(1) {
  width: 56px;
}
#app > div.theme-container.sidebar-open.have-rightmenu.only-sidebarItem > div:nth-child(6) > main > div.theme-vdoing-wrapper > div.content-wrapper > div.theme-vdoing-content.content__default > table:nth-child(134) > thead > tr > th:nth-child(2) {
  width: 158px;
}
#app > div.theme-container.sidebar-open.have-rightmenu.only-sidebarItem > div:nth-child(6) > main > div.theme-vdoing-wrapper > div.content-wrapper > div.theme-vdoing-content.content__default > table:nth-child(134) > thead > tr > th:nth-child(5) {
  width: 150px;
}
</style>
