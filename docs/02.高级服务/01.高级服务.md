...
<h5>Max、Max-Ts、Js、Max-Js 这四个版本有什么区别？</h5>
...
<style scoped>
#app > div.theme-container.sidebar-open.have-rightmenu.only-sidebarItem > div:nth-child(5) > main > div.theme-vdoing-wrapper > div.content-wrapper > div.theme-vdoing-content.content__default > table:nth-child(139) > tbody > tr:nth-child(2) > td:nth-child(1) {
  width: 56px;
}
</style>
