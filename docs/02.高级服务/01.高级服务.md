...
<p style="color:red;font-size:22px"> 补差价活动即将结束：<br />
Js、Max版本将不再支持补差价升级到Max-Js、Max-Ts版本；<br />
Js、Max、Max-Ts、Max-Js版本将不再支持补差价升级到解答微信群！<br />
需要的伙伴可以入手了，错过本次活动，下次补差价活动还需再等一年！</p>
<p id="max-time" style="color: red;font-size:24px" />
...
<style scoped>
#app > div.theme-container.sidebar-open.have-rightmenu.only-sidebarItem > div:nth-child(5) > main > div.theme-vdoing-wrapper > div.content-wrapper > div.theme-vdoing-content.content__default > table:nth-child(143) > thead > tr > th:nth-child(1) {
  width: 56px;
}
#app > div.theme-container.sidebar-open.have-rightmenu.only-sidebarItem > div:nth-child(5) > main > div.theme-vdoing-wrapper > div.content-wrapper > div.theme-vdoing-content.content__default > table:nth-child(143) > thead > tr > th:nth-child(2) {
  width: 158px;
}
#app > div.theme-container.sidebar-open.have-rightmenu.only-sidebarItem > div:nth-child(5) > main > div.theme-vdoing-wrapper > div.content-wrapper > div.theme-vdoing-content.content__default > table:nth-child(143) > thead > tr > th:nth-child(5) {
  width: 150px;
}
</style>
