...
平台回答：我们会提供免费的教学视频，会演示如何将系统管理里的所有页面和`src/components`里的部分组件改为`js`版本并放到`pure-admin-thin-js`中

教程地址：[点击观看教程](https://www.bilibili.com/video/BV1Wr421F7oj/)

<span style="color: red">当然有免费视频是不够的，我们还会提供详细的迁移`JS`版本文档。当恢复</span>`￥299`<span style="color: red">原价后，免费文档将开放于所有购买</span>`JS`<span style="color: red">版本的朋友 🤝 我这边都有备注，会主动联系您们并发送文档链接。</span>
